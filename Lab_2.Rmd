...
```
There are no isolates in the network when I ran this origionally, however every time we run the code we get a new random network, so sometimes there are isolates. 
