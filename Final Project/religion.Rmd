...
combyos <- combos_112 %>% 
  mutate(catholics = ifelse(religion_i == 1 & religion_j == 1, 1, 0 )) %>% 
  select(-religion_i, -religion_j)

#turn into graph object
g_112=graph.data.frame(combyos)

#get adjacency matrix
catholic_ties <- get.adjacency(g_112, sparse = FALSE, attr='catholics')

#export it for easier work!
write.csv(catholic_ties, "catholic_112.csv", row.names=FALSE)
```
...
#create similarity score
combyos <- combos_112 %>% 
  mutate(jews = ifelse(religion_i == 2 & religion_j == 2, 1, 0 )) %>% 
  select(-religion_i, -religion_j)
...
#get adjacency matrix
jewish_ties <- get.adjacency(g_112, sparse = FALSE, attr='jews')

#export it for easier work!
write.csv(jewish_ties, "jewish_112.csv", row.names=FALSE)
```
...
#create similarity score
combyos <- combos_112 %>% 
  mutate(other = ifelse(religion_i == 3 & religion_j == 3, 1, 0 )) %>% 
  select(-religion_i, -religion_j)
...
#get adjacency matrix
jewish_ties <- get.adjacency(g_112, sparse = FALSE, attr='other')

#export it for easier work!
write.csv(jewish_ties, "other_112.csv", row.names=FALSE)
```
...
#create similarity score
combyos <- combos_112 %>% 
  mutate(protestant = ifelse(religion_i == 4 & religion_j == 4, 1, 0 )) %>% 
  select(-religion_i, -religion_j)
...
#get adjacency matrix
protestant_ties <- get.adjacency(g_112, sparse = FALSE, attr='protestant')

#export it for easier work!
write.csv(protestant_ties, "protestant_112.csv", row.names=FALSE)
```
...
#create similarity score
combyos <- combos_112 %>% 
  mutate(unknown = ifelse(religion_i == 5 & religion_j == 5, 1, 0 )) %>% 
  select(-religion_i, -religion_j)
...
#get adjacency matrix
unknown_ties <- get.adjacency(g_112, sparse = FALSE, attr='unknown')

#export it for easier work!
write.csv(unknown_ties, "unknown_112.csv", row.names=FALSE)
```
...
#create similarity score
pp <- combos_117_part_two_electric_boogaloo %>% 
  mutate(catholic = ifelse(religion_i == 1 & religion_j == 1, 1, 0 )) %>% 
  select(-religion_i, -religion_j)

#turn into graph object
g_117=graph.data.frame(pp)

#get adjacency matrix
catholic_ties <- get.adjacency(g_117, sparse = FALSE, attr='catholic')

#export it for easier work!
write.csv(catholic_ties, "catholic_117.csv", row.names=FALSE)
```
...
#get adjacency matrix
jewish_ties <- get.adjacency(g_117, sparse = FALSE, attr='jews')

#export it for easier work!
write.csv(jewish_ties, "jew_117.csv", row.names=FALSE)
```
...
#get adjacency matrix
other_ites <- get.adjacency(g_117, sparse = FALSE, attr='other')

#export it for easier work!
write.csv(other_ites, "other_117.csv", row.names=FALSE)
```
...
#get adjacency matrix
protestant <- get.adjacency(g_117, sparse = FALSE, attr='protestant')

#export it for easier work!
write.csv(protestant, "protestant_117.csv", row.names=FALSE)
```
...
#get adjacency matrix
unknown <- get.adjacency(g_117, sparse = FALSE, attr='unknown')

#export it for easier work!
write.csv(unknown, "unknown_117.csv", row.names=FALSE)
```
