...
```{r fig:percentgraph, fic.cap = "The final distribution of our 5 overarching religious groups for both the 112th and 117th Congressional Sessions.\\label{fig:percentgraph}"}
...
```{r 112th_religion, fig.cap= "Using the Pew Research Center's methodology for "}
