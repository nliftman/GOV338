...
#getting the party 
first$party <- with(first, ifelse(first %like% " R ", "Republican", "Democrat"))

#removing the white spaces
first$first <- gsub(" ","", as.character(first$first))

#remove the first two letters and the senator or other stuff
first$first <- gsub('AL','',first$first)
