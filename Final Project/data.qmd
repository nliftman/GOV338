...
#convert to a network FROM COSPONSORSHIP
...
mat_112 <- as.matrix((net_112))

#trying to make a network from religion?
net_112_2 <- graph.data.frame(rel_112, directed = F)
mat_112_2 <- as.matrix(get.adjacency(net_112_2, attr = rel_112$fix_relig))
```
